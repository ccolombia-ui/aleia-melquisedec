# Ingeniería Ontológica: Investigación Académica

---
**Metadata (Dublin Core + Spec Extensions)**

```yaml
title: "Ingeniería Ontológica: Investigación Académica"
creator: "HYPATIA"
date: "2026-01-11"
description: "Investigación académica comprehensiva sobre metodologías de ingeniería ontológica (ISO 25964-1, METHONTOLOGY, NeOn) y su aplicación en Triple Persistencia ALEIA-MELQUISEDEC"
subject: ["Ontology Engineering", "Knowledge Management", "Semantic Web", "Neo4j", "Triple Persistence"]
language: "es"
format: "text/markdown"
publisher: "Aleia-Melquisedec Research Repository"
contributor: ["HYPATIA (Research Lead)", "SALOMON (Synthesis)"]
spec:issue: "SPEC-001"
spec:owner: "HYPATIA"

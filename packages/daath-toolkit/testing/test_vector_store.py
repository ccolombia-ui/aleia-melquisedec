...
class TestDomainAwareVectorStore:
    ...
    def test_initialization_creates_index_if_not_exists(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_upsert_artifact_generates_embedding(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_upsert_artifact_uses_correct_namespace(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_search_in_domain_queries_correct_namespace(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_search_in_instance_uses_specific_namespace(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_upsert_artifact_includes_metadata(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_delete_artifact_removes_from_namespace(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_get_domain_stats_returns_namespace_info(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_search_with_metadata_filter(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_embedding_dimension_configurable(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_empty_search_results_handled(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
    ...
    @patch('storage.vector_store.Pinecone')
    @patch('storage.vector_store.OpenAI')
    def test_artifact_type_validation(self, mock_openai_class, mock_pinecone_class, mock_pinecone_client, mock_openai_client):
